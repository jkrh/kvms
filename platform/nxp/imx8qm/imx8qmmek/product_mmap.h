...
static const memmap base_memmap[] = {
	...
	/* DDR */
	{ 0x880000000, 0x97FFFFFFF, 0x880000000, 0x100000000, NORMAL_WBACK_P, SH_INN, PAGE_KERNEL_RW }, /* 4GB DDR Main memory */
	/* DDR */
	{ 0x80000000, 0xFFFFFFFF, 0x80000000, 0x80000000, NORMAL_WBACK_P, SH_INN, PAGE_KERNEL_RW }, /* 2GB DDR Main memory */
	/* DMA.LPUART0 (UART0)*/
	{ 0x5A060000, 0x5A06FFFF, 0x5A060000, 0x10000, DEVICE_MEMORY, SH_INN, PAGE_KERNEL_RW }, /* 64kB DMA.LPUART0 */
	{ 0, 0, 0, 0, 0 }
};
...
static const memmap st2_base_memmap[] = {
	...
	/* DDR */
	{ 0x880000000, 0x97FFFFFFF, 0x880000000, 0x100000000, S2_NORMAL_MEMORY, SH_INN, PAGE_HYP_RWX }, /* 4GB DDR Main memory */
	/* Reserved */
	...
	/* LSIO */
	{ 0x400000000, 0x43FFFFFFF, 0x400000000, 0x40000000, S2_DEV_NGNRE, PAGE_HYP_RW, PAGE_HYP_RW }, /* 1GB FlexSPI1 + Other */
	/* Reserved */
	...
	/* LSIO */
	{ 0x5D000000, 0x5DFFFFFF, 0x5D000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB Memory Slave Block */
	/* Db */
	{ 0x5C000000, 0x5CFFFFFF, 0x5C000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB DRAM Slave Block */
	/* Conn */
	{ 0x5B000000, 0x5BFFFFFF, 0x5B000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB Connectivity */
	/* DMA */
	{ 0x5A000000, 0x5AFFFFFF, 0x5A000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB DMA */
	/* Audio */
	{ 0x59000000, 0x59FFFFFF, 0x59000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB Audio */
	/* Imaging */
	{ 0x58000000, 0x58FFFFFF, 0x58000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB Imaging Subsystem */
	/* DC1 */
	{ 0x57000000, 0x57FFFFFF, 0x57000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB Display Controller 1 */
	/* DC0 */
	{ 0x56000000, 0x56FFFFFF, 0x56000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB Display Controller 0 */
	/* VPU */
	{ 0x55000000, 0x55FFFFFF, 0x55000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB Audio DSP */
	/* GPU1 */
	{ 0x54000000, 0x54FFFFFF, 0x54000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB Graphics 1 */
	/* GPU0 */
	{ 0x53000000, 0x53FFFFFF, 0x53000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB Graphics 0 */
	/* CCI */
	{ 0x52000000, 0x52FFFFFF, 0x52000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB Core Coherent Interconnect */
	/* DBLOG */
	{ 0x51000000, 0x51FFFFFF, 0x51000000, 0x1000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 16MB DB Logic */
	/* Reserved */
	...
	/* CM4-1 */
	{ 0x38000000, 0x3BFFFFFF, 0x38000000, 0x4000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 64MB Cortex M4 Platform 1 */
	/* CM4-0 */
	{ 0x34000000, 0x37FFFFFF, 0x34000000, 0x4000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 64MB Cortex M4 Platform 0 */
	/* SCU */
	{ 0x30000000, 0x33FFFFFF, 0x30000000, 0x4000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 64MB System Control General */
	/* VPU */
	{ 0x2C000000, 0x2FFFFFFF, 0x2C000000, 0x4000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 64MB Video Processing Unit */
	/* Reserved */
	/* { 0x28000000, 0x2BFFFFFF, 0x28000000, 0x4000000, type, sh, exec },  64MB Reserved */
	/* Reserved */
	/* { 0x20000000, 0x27FFFFFF, 0x20000000, 0x8000000, type, sh, exec },  128MB Reserved */
	/* Reserved */
	/* { 0x1C000000, 0x1FFFFFFF, 0x1C000000, 0x4000000, type, sh, exec },  64MB Reserved */
	/* LSIO */
	{ 0x08000000, 0x1BFFFFFF, 0x08000000, 0x14000000, S2_DEV_NGNRE, SH_INN, PAGE_HYP_RW }, /* 320MB FlexSPI0 + Other */
	/* Reserved */
