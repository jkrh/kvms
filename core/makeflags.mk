...
export DEFINES := -D$(PVAR) -D_GNU_SOURCE -D__OPTIMIZE__ \
		-DMAX_THRESH=$(MAX_PAGING_BLOCKS) -DMAX_PAGING_BLOCKS=$(MAX_PAGING_BLOCKS) -include "config.h"
export WARNINGS := -Wall -Werror -Wno-pointer-arith -Wno-variadic-macros -Wstack-protector -Wstack-usage=8192
